                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 h-12 text-base ${
                      errors.receiver ? 'border-destructive focus:border-destructive' : ''
                    }`}
                    {...register('receiver', {
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      ...
                      className={`pl-10 min-h-[100px] text-base resize-none ${
                        errors.fromAddress ? 'border-destructive focus:border-destructive' : ''
                      }`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Textarea
                      ...
                      className={`pl-10 min-h-[100px] text-base resize-none ${
                        errors.toAddress ? 'border-destructive focus:border-destructive' : ''
                      }`}
                      {...register('toAddress', {
